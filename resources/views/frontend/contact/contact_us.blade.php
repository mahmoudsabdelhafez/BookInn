...
<div class="contact-area pt-100 pb-70">
    ...
    <form method="POST" action="{{ route('store.contact') }}" >
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="form-group">
                    <input type="phone" name="phone" id="phone_number"  required data-error="Please enter your number" class="form-control" placeholder="Phone">
                    @error('phone')
                <small class="text-danger">{{ $message }}</small>
                @enderror
                    <div class="help-block with-errors"></div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="form-group">
                    <textarea required name="message" class="form-control" id="message" cols="30" rows="8" required data-error="Write your message" placeholder="Your Message"></textarea>
                    @error('message')
                <small class="text-danger">{{ $message }}</small>
                @enderror
                    <div class="help-block with-errors"></div>
