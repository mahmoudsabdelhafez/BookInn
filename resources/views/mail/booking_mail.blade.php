...
<h1 style="color:#199e59;direction:ltr;font-family:'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:74px;font-weight:700;letter-spacing:normal;line-height:120%;text-align:left;margin-top:0;margin-bottom:0;">BookInn<br/> </h1>
</div>
<div class="bee-block bee-block-3 bee-paragraph">
<p>Thanks for booking with BookInn<br/>Enjoy your stay with us and we look forward to seeing you again</p>
</div>
...
<p style="font-size: 14px; line-height: 16px; text-align: center;"><span style="font-size: 12px; line-height: 14px;">2025 © All Rights Reserved</span></p>
</div>
</div>
</div>
</div>
