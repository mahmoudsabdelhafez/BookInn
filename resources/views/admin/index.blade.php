...
@section('admin')
            ...
            <div class="col">
                <div class="card radius-10 border-start border-0 border-4 border-success">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Complete Bookings</p>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <p class="mb-0 font-13">Today Income: {{ $todayprice }}$</p>
    ...
    <script>
        ...
        var labels = bookings.map(function(booking) { // x axis
            return booking.check_in;
        });

        var data = bookings.map(function(booking) { // y axis
